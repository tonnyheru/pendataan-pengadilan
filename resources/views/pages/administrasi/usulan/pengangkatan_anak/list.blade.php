...
<div class="col-lg-6 col-7">
  ...
  <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
    <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
      ...
      <li class="breadcrumb-item active" aria-current="page">Pengangkatan Anak</li>
    </ol>
  </nav>
</div>
@endsection
...
<script>
  let _url = {
    create: `{{ route('pengangkatan_anak.create') }}`,
    edit: `{{ route('pengangkatan_anak.edit', ':id') }}`,
    show: `{{ route('pengangkatan_anak.show', ':id') }}`,
    destroy: `{{ route('pengangkatan_anak.destroy', ':id') }}`,
    show_catatan: `{{ route('pengangkatan_anak.show_catatan', ':id') }}`,
  ...
  function save(){
    ...
    $.ajax({
      ...
      if(res?.status == true){
        ...
        Ryuna.close_modal()
        window.LaravelDataTables["pengangkatananakdetail-table"].draw()
      }
    }).fail((xhr) => {
      if(xhr?.status == 422){
