...
@section('title', 'Penerbitan Akta Perceraian')
...
<div class="col-lg-6 col-7">
  ...
  <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
    <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
      ...
      <li class="breadcrumb-item active" aria-current="page">Penerbitan Akta Perceraian</li>
    </ol>
  </nav>
</div>
@endsection
...
<script>
  let _url = {
    create: `{{ route('akta_perceraian.create') }}`,
    edit: `{{ route('akta_perceraian.edit', ':id') }}`,
    show: `{{ route('akta_perceraian.show', ':id') }}`,
    destroy: `{{ route('akta_perceraian.destroy', ':id') }}`,
    show_catatan: `{{ route('akta_perceraian.show_catatan', ':id') }}`,
  ...
  function save(){
    ...
    $.ajax({
      ...
      if(res?.status == true){
        ...
        Ryuna.close_modal()
        window.LaravelDataTables["aktaperceraiandetail-table"].draw()
      }
    }).fail((xhr) => {
      if(xhr?.status == 422){
