...
@section('title', 'Pembatalan Perceraian')
...
<div class="col-lg-6 col-7">
  ...
  <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
    <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
      ...
      <li class="breadcrumb-item active" aria-current="page">Pembatalan Perceraian</li>
    </ol>
  </nav>
</div>
@endsection
...
<script>
  let _url = {
    create: `{{ route('pembatalan_perceraian.create') }}`,
    edit: `{{ route('pembatalan_perceraian.edit', ':id') }}`,
    show: `{{ route('pembatalan_perceraian.show', ':id') }}`,
    destroy: `{{ route('pembatalan_perceraian.destroy', ':id') }}`,
    show_catatan: `{{ route('pembatalan_perceraian.show_catatan', ':id') }}`,
  ...
  function save(){
    ...
    $.ajax({
      ...
      if(res?.status == true){
        ...
        Ryuna.close_modal()
        window.LaravelDataTables["pembatalanperceraiandetail-table"].draw()
      }
    }).fail((xhr) => {
      if(xhr?.status == 422){
