...
<script>
  let _url = {
    create: `{{ route('perbaikan_akta.create') }}`,
    edit: `{{ route('perbaikan_akta.edit', ':id') }}`,
    show: `{{ route('perbaikan_akta.show', ':id') }}`,
    destroy: `{{ route('perbaikan_akta.destroy', ':id') }}`,
    show_catatan: `{{ route('perbaikan_akta.show_catatan', ':id') }}`,
