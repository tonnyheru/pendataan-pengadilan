...
@section('title', 'Pengesahan dan Pengakuan Anak')
...
<div class="col-lg-6 col-7">
  ...
  <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
    <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
      ...
      <li class="breadcrumb-item active" aria-current="page">Pengesahan dan Pengakuan Anak</li>
    </ol>
  </nav>
</div>
@endsection
...
<script>
  let _url = {
    create: `{{ route('pengakuan_anak.create') }}`,
    edit: `{{ route('pengakuan_anak.edit', ':id') }}`,
    show: `{{ route('pengakuan_anak.show', ':id') }}`,
    destroy: `{{ route('pengakuan_anak.destroy', ':id') }}`,
    show_catatan: `{{ route('pengakuan_anak.show_catatan', ':id') }}`,
  ...
  function save(){
    ...
    $.ajax({
      ...
      if(res?.status == true){
        ...
        Ryuna.close_modal()
        window.LaravelDataTables["pengakuananakdetail-table"].draw()
      }
    }).fail((xhr) => {
      if(xhr?.status == 422){
