...
@section('title', 'Pembatalan Perkawinan')
...
<div class="col-lg-6 col-7">
  ...
  <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
    <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
      ...
      <li class="breadcrumb-item active" aria-current="page">Pembatalan Perkawinan</li>
    </ol>
  </nav>
</div>
@endsection
...
<script>
  let _url = {
    create: `{{ route('pembatalan_perkawinan.create') }}`,
    edit: `{{ route('pembatalan_perkawinan.edit', ':id') }}`,
    show: `{{ route('pembatalan_perkawinan.show', ':id') }}`,
    destroy: `{{ route('pembatalan_perkawinan.destroy', ':id') }}`,
    show_catatan: `{{ route('pembatalan_perkawinan.show_catatan', ':id') }}`,
  ...
  function save(){
    ...
    $.ajax({
      ...
      if(res?.status == true){
        ...
        Ryuna.close_modal()
        window.LaravelDataTables["pembatalanperkawinandetail-table"].draw()
      }
    }).fail((xhr) => {
      if(xhr?.status == 422){
