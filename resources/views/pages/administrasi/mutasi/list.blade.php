...
<div class="col-lg-6 col-7">
  ...
  <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
    <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
      <li class="breadcrumb-item"><a href="#"><i class="fas fa-file-exclamation"></i></a></li>
      <li class="breadcrumb-item active" aria-current="page">Mutasi Data</li>
    </ol>
  </nav>
</div>
@endsection
...
<script>
  let _url = {
    create: `{{ route('mutasi.create') }}`,
    edit: `{{ route('mutasi.edit', ':id') }}`,
    show: `{{ route('mutasi.show', ':id') }}`,
    destroy: `{{ route('mutasi.destroy', ':id') }}`
  }
