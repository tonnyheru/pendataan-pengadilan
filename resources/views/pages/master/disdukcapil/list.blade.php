...
<div class="col-lg-6 col-7">
  ...
  <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
    <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
      <li class="breadcrumb-item"><a href="#"><i class="fas fas fa-poll-people"></i></a></li>
      <li class="breadcrumb-item active" aria-current="page">Disdukcapil</li>
    </ol>
  </nav>
</div>
@endsection
...
<script>
  let _url = {
    create: `{{ route('disdukcapil.create') }}`,
    edit: `{{ route('disdukcapil.edit', ':id') }}`,
    show: `{{ route('disdukcapil.show', ':id') }}`,
    destroy: `{{ route('disdukcapil.destroy', ':id') }}`
  }
  ...
  function save(){
    ...
    $.ajax({
      ...
      if(res?.status == true){
        ...
        window.LaravelDataTables["disdukcapil-table"].draw()
      }
    }).fail((xhr) => {
      if(xhr?.status == 422){
