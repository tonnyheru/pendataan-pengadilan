...
class PerbaikanAktaDetailDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\PerbaikanAktaDetail $model
    ...
    public function html(): HtmlBuilder
    {
        ...
        return $this->builder()
            ...
            ->setTableId('perbaikanaktadetail-table')
    ...
    {
        return 'PerbaikanAktaDetail_' . date('YmdHis');
    }
}
